...
template<typename FDType, typename RequestIDType>
void FileTracker<FDType, RequestIDType>::track_file_closed(const FDType fd) 
{
...
template<typename FDType, typename RequestIDType>
void FileTracker<FDType, RequestIDType>::register_request(const RequestIDType request_id, const FDType fd) 
{
	auto it = file_register.find(fd);
	if (it != file_register.end()) {
		auto path = it->second;
...
template<typename FDType, typename RequestIDType>
void FileTracker<FDType, RequestIDType>::unregister_request(const RequestIDType request_id) 
{
	auto it = request_register.find(request_id);
	if(it != request_register.end()) {
